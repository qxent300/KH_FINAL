				...
				<c:forEach var="book" items="${bestsellerList}" varStatus="status">
					<div class="swiper-slide h-auto px-2">
                        <div class="card card-poster gradient-overlay hover-animate mb-4 mb-lg-0">
                            <a class="tile-link" href="${path}/book/view"></a>
                            <img class="bg-image" src="${path}/resources/book/${book.bImage}" alt="Card image">
                            <div class="card-body overlay-content">
                                <h6 class="card-title text-shadow text-uppercase"></h6>
                            </div>
                        </div><br>
                        <div style="text-align: center;">
                            <h6 class="card-title text-shadow text-uppercase">${book.bName}</h6>
                            <p class="card-text text-sm">${book.bWriter}</p>
                        </div>
                    </div>
				</c:forEach>
				</c:if>
