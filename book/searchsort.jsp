                ...
                <div class="pt-6">
                    <div class="container">
                    	<c:if test="${sortname.equals('publish_date')}">
 	                       <h4 class="mb-3 text-center" style="color: rgba(175, 170, 170, 0.918);">출간일순</h4>
                    	</c:if>
                    	<c:if test="${sortname.equals('rentcount')}">
 	                       <h4 class="mb-3 text-center" style="color: rgba(175, 170, 170, 0.918);">대여순</h4>
                    	</c:if>
                    	<c:if test="${sortname.equals('avgscore')}">
 	                       <h4 class="mb-3 text-center" style="color: rgba(175, 170, 170, 0.918);">평점순</h4>
                    	</c:if>

                        <ul class="nav justify-content-end">
                           <li class="nav-item">
                                <a class="nav-link text-dark fw-bold active" href="searchsort?sortname=publish_date">
                                출간일순
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="searchsort?sortname=rentcount">대여순</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold" href="searchsort?sortname=avgscore">평점순</a>
                            </li>
                        </ul>
