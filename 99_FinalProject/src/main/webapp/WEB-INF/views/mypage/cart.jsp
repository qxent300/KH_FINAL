	...
	<section class="py-5">
      <div class="container" style="padding-top: 100px;">
        ...
        <c:if test="${cartList != null}">
	        <div class="d-flex justify-content-between align-items-center flex-column flex-lg-row mb-3 text-end">
		                ...
		                <div class="row">
		                  <div class="col-6 col-md-4 col-lg-3 py-3 mb-3 mb-lg-0">
		                    ...
		                    <p class="text-sm fw-bold">
		                    	<fmt:formatDate value="${cart.publishDate}" pattern="20dd년 MM월 yy일"/>
		                    </p>
		                  </div>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6ebae7ae9f0b65515c7872a1afe82ea5"></script>
