                        ...
                        <form action="#">
                            <div class="row">
                                <div class="col-lg-2 d-flex align-items-center form-group">
                                    <select name="division" onchange="handleOnChange(this)" style="width: 160px; border-style: none;">
    ...
    <section class="py-6 bg-gray-100">
        <div class="container d-grid col-sm-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-3 mb-lg-0 text-center">
                    <div>
                        <a href="./bookDetail.html"><img src="${path}/images/2.jpg" class="rounded w-85 mb-3" height="320px"></a>
                    </div>
                    <h3 class="h5">책 제목</h3>
                    <p class="text-muted">저자? 간략한 설명?</p>
                </div>
                <div class="col-lg-3 mb-3 mb-lg-0 text-center">
                    <div>
                        <a href="./bookDetail.html"><img src="${path}/images/3.jpg" class="rounded w-85 mb-3" height="320px"></a>
                    </div>
                    <h3 class="h5">책 제목</h3>
                    <p class="text-muted">저자? 간략한 설명?</p>
                </div>
                <div class="col-lg-3 mb-3 mb-lg-0 text-center">
                    <div>
                        <a href="./bookDetail.html"><img src="${path}/images/4.jpg" class="rounded w-85 mb-3" height="320px"></a>
                    </div>
                    <h3 class="h5">책 제목</h3>
                    <p class="text-muted">저자? 간략한 설명?</p>
                </div>
                ...
                <div class="swiper-wrapper pb-5">
                    ...
                    <div class="swiper-slide h-auto px-2">
                        <div class="card card-poster gradient-overlay hover-animate mb-4 mb-lg-0">
                            <a class="tile-link" href="bookDetail.html"></a><img class="bg-image" src="${path}/images/new-york.jpg" alt="Card image">
