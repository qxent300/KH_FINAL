    ...
    <div class="bg-gray-100">
        <div class="col-sm-10 container d-grid">
            ...
            <div class="col-10 me-5 d-grid gap-3 container bg-gray-100" style="padding-right: 0px;">
                <div class="pt-6">
                    <div class="container">
                        <h4 class="mb-3 text-center" style="color: rgba(175, 170, 170, 0.918);">자기계발</h4>

                        <ul class="nav justify-content-end">
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-bold active" href="searchsort?sort=publish_date">출간일순</a>
                            </li>
                            <li class="nav-item">
				 ...
				 <c:if test="${selfDevList != null}">
                <c:forEach var="book" items="${selfDevList}" varStatus="status">
