...
<div class="d-grid gap-4 container py-7">
        ...
        <div class="row align-items-md-center justify-content-end">
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="card-pinned">
                    <img style="max-width: 250px; width: 100%;" class="border border-1" src="${path}/book/${book.BImage}">
            ...
            <div class="col-sm-7">
                ...
                <small class="card-subtitle text-body">${book.BWriter} / <fmt:formatDate pattern="20dd년 MM월 yy일" value="${book.publishDate}"/></small><br>
                <!-- End Col -->
                <!-- End Row -->

                <span class="gap-1" href="#reviewSection" style="text-decoration: none;">
				...
				<c:if test="${scoreAvg eq 'NaN'}">
                    <span class="ms-1 small">(평가 없음)</span>
				</c:if>
                </span> /
                    <span class="small">한줄평(${scoreCount}건)</span>

                <div class="row align-items-center mb-3">
                </div>
                <!-- End Row -->
                <a href="${path}/mypage/cart" class="btn btn-primary"><em class="bi-cart fw-bold"> 카트에 넣기</em></a>
                <a href="#" class="btn btn-info"><em class="bi-book fw-bold"> 대여하기</em></a>
            </div>
            <!-- End Col -->
        </div>
        <!-- End Row -->
        ...
        <div class="row col-10 m-auto mt-2">
                <!-- Nav -->
                <ul class="nav nav-segment nav-fill mb-4 fw-bold" id="featuresTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="#featuresTwo" id="featuresTwo-tab" data-bs-toggle="tab" data-bs-target="#featuresTwo" role="tab" aria-controls="featuresTwo" aria-selected="false" style="min-width: 7rem;">한줄평(${scoreCount}건)</a>
                    </li>
                ...
                <form action="${path}/book/score" method="post">
                    <div class="row justify-content-sm-between align-items-sm-center border-bottom pb-3 mb-4">
                        <div class="col-sm-9 mb-2 mb-sm-0">
                            <h4 class="mb-0">한줄평<small class="text-muted ms-1">(${scoreCount}건)</small></h4>
                            ...
                            <textarea id="commentarea" name="sContent" class="form-control" placeholder="한글 기준 50자까지 작성 가능합니다." style="width: 770px" rows="2"></textarea>
                        </div>
                        <div class="col-sm-2">
                            <button type="submit" id="btnSubmit" class="btn btn-lg btn-primary rounded-1 fw-bold" style="width: 100%; height: 65px; margin-top: 98px;">등록</button>
                        </div>
                        <!-- End Col -->
                        ...
                        <div class="align-items-center text-center">
                            <div class="flex-grow-1 ms-4 mt-3">
                                <!-- Rating --> 		
                                	...
                                	<c:if test="${scoreAvg ne 'NaN'}">
                                <h3><span class="text-primary fw-bold">${scoreCount}</span>명의 회원이 평가한 평균별점</h3>
                                ...
                                <img src="${path}/images/star.svg" width="50">
                                	<div class="flex-shrink-0">
                                    	<span class="display-4 text-dark">${scoreAvg}</span>
                                </div>
                                    </c:if>
                                <!-- End Rating -->
                            </div>
                    ...
                    <!-- Comment -->
                        ...
                        <!-- Item -->
							...
							<c:forEach var="score" items="${scoreList}">
									...
									<span class="text-dark">${score.UNickName} / ${score.score}점(테스트)<sub class="text-dark float-end"><fmt:formatDate pattern="yy-MM-dd hh:mm:ss" value="${score.createDate}" /></sub></span>
