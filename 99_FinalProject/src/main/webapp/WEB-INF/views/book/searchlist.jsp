    ...
    <div class="bg-gray-100">
        <div class="col-sm-10 container d-grid">
            <div id="aside" class="position-fixed rounded" style="width: 200px; height: 370px; margin-left: -80px;  margin-top: 40px; background-color: rgba(104, 157, 218, 0.808);"><br>
                ...
                <ol type="submit" onclick="location.href='${path}/book/novel'" style="font-size: large; color: white; font-weight: bold;">소설</ol>
                <ol type="submit" onclick="location.href='${path}/book/poem'" style="font-size: large; color: white; font-weight: bold;">시/에세이</ol>
                <ol type="submit" onclick="location.href='${path}/book/economy'" style="font-size: large; color: white; font-weight: bold;">경제/경영</ol>
                <ol type="submit" onclick="location.href='${path}/book/selfDevelopment'" style="font-size: large; color: white; font-weight: bold;">자기계발</ol>
                <ol type="submit" onclick="location.href='${path}/book/humanities'" style="font-size: large; color: white; font-weight: bold;">인문</ol>
                <ol type="submit" onclick="location.href='${path}/book/historyCulture'" style="font-size: large; color: white; font-weight: bold;">역사/문화</ol>
            </div>
