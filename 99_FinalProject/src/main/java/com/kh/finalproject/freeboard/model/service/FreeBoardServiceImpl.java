...
public class FreeBoardServiceImpl implements FreeBoardService {
	...
	@Override
	public List<FreeBoard> getAllFreeBoardList(PageInfo pageInfo) {	// 게시글 별로 댓글 수를 업데이트하여 전체 게시글을 조회하는 코드로 자유공간 페이지 접속시 반드시 먼저 실행해야 한다.
	...
	public List<FreeBoard> getAllFreeBoardList() {
		return mapper.selectAllFreeBoardList();
	}
