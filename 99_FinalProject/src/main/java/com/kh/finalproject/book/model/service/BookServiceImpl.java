...
//				System.out.println("도서 평점 업데이트 실패...");
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public List<Book> getAllTodayBookList() {
		List<Book> list = mapper.selectAllHomeList();	// 전체 도서 검색
		return list;
	}
	...
	public List<Book> getBestsellerList() {
		List<Book> list = mapper.selectBestsellerList();	// 전체 도서 검색
		return list;
	}
	...
	public List<Book> getNewBookList() {
		List<Book> list = mapper.selectNewBookList();	// 전체 도서 검색
		return list;
	}
	
	@Override
	@Transactional(rollbackFor = Exception.class)
	public List<Book> getSearchBookList(String keyword, String option) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("keyword", keyword);
		params.put("option", option);
		
		List<Book> list = mapper.selectSearchBookList(params);	// 전체 도서 검색
		return list;
	}
}
